...
--
-- Table structure for table uni.admin`
--

CREATE table uni.admin(
  id int(11) NOT NULL,
...
--
-- Dumping data for table uni.admin`
--

INSERT INTO uni.uni.admin(id, username, password) VALUES
...
--
-- Table structure for table uni.attn`
--

CREATE table uni.attn(
  id int(11) NOT NULL,
...
--
-- Dumping data for table uni.attn`
--

INSERT INTO uni.attn(id, st_id, atten, at_date) VALUES
...
--
-- Table structure for table uni.at_student`
--
...
--
-- Dumping data for table uni.at_student`
--

INSERT INTO uni.at_student(id, name, st_id) VALUES
...
--
-- Table structure for table uni.faculty`
--

CREATE table uni.faculty(
 id int(11) NOT NULL,
...
--
-- Dumping data for table uni.faculty`
--

INSERT INTO uni.faculty(id, username, password, name, email, birthday, gender, education, contact, address) VALUES
...
--
-- Table structure for table uni.result`
--

CREATE table uni.result(
  id int(11) NOT NULL,
  st_id int(11) NOT NULL,
...
INSERT INTO uni.result(id, st_id, marks, sub, semester) VALUES
...
--
-- Table structure for table uni.st_info`
--

CREATE table uni.st_info(
  st_id int(11) NOT NULL,
...
--
-- Dumping data for table uni.st_info`
--

INSERT INTO uni.st_info(st_id, name, password, email, bday, program, contact, gender, address, img) VALUES
...
--
-- Indexes for table uni.admin`
--
ALTER table uni.admin
  ADD PRIMARY KEY (id);

--
-- Indexes for table uni.attn`
--
ALTER table uni.attn
  ADD PRIMARY KEY (id);

--
-- Indexes for table uni.at_student`
--
ALTER table uni.at_student
  ADD PRIMARY KEY (id);

--
-- Indexes for table uni.faculty`
--
ALTER table uni.faculty
  ADD PRIMARY KEY (id),
  ADD UNIQUE KEY (username);

--
-- Indexes for table uni.result`
--
ALTER table uni.result
  ADD PRIMARY KEY (id);

--
-- Indexes for table uni.st_info`
--
ALTER table uni.st_info
...
--
-- AUTO_INCREMENT for table uni.attn
--
ALTER table uni.attn
  MODIFY id int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=225;

--
-- AUTO_INCREMENT for table uni.at_student
--
ALTER table uni.at_student
  MODIFY id int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table uni.faculty
--
ALTER table uni.faculty
  MODIFY id int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table uni.result
--
ALTER table uni.result
